...
Obiettivo: Scaricare il contenuto di una pagina web (es. http://data.pr4e.org/romeo.txt) e stamparlo a schermo riga per riga (senza modifiche, mantenendo spazi e newline).
...
Output atteso: Il testo esatto del file, incluso il carattere di newline alla fine di ogni riga.
"""
...
Obiettivo: Scaricare il testo da un URL, contare il numero totale di parole (separate da spazi, newline, punteggiatura) e stamparlo.
